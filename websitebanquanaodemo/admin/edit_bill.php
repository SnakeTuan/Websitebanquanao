...
<div class="admin-content-right">
            <div class="admin-right-add">
                ...
                <a style="margin-right: 30%;" href="list_bill.php"><button>Quay lại</button></a>
                <a style="margin-right: 30%;" href="execute_bill.php?delete=1&waiting_bill_id=<?php echo $waiting_bill_id ?>"><button>Xóa</button></a>
                <a href="execute_bill.php?delete=0&waiting_bill_id=<?php echo $waiting_bill_id ?>"><button>Xác nhận</button></a>
                </div>
            </div>
        </div>
    </section>
